...
| ----------------------- | ------------------------------------------------ | ----------- |
| Foundation              | Tooling, docs, design shell, asset policy        | Implemented |
| Camera and tracking     | Shared camera, worker, landmarks, two hands      | Implemented |
| Gestures                | Canned/custom gestures, stability, lifecycle     | Implemented |
| Motion and pointer      | Movement, smoothing, hover, click                | Implemented |
| Single-hand interaction | Drag state and magnetic attraction               | Implemented |
